...
def write_parquet(
    ...
    *,
    ...
    definitions = {
        ...
        "s_blow_m": "Raw blow-out radius inferred from the ⟨Q_pr⟩/β solution [m].",
        "s_blow_m_effective": "Blow-out radius after applying the size-floor clipping (legacy effective value) [m].",
