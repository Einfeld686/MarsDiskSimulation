...
@dataclass
class RunZeroDSupplyStage:
    supply_spec: Any
    supply_enabled_cfg: bool
    supply_mode_value: str
    supply_headroom_policy: str
    supply_headroom_enabled: bool
    supply_epsilon_mix: Optional[float]
    supply_const_rate: Optional[float]
    supply_mu_orbit_cfg: Optional[float]
    supply_orbit_fraction: Optional[float]
    supply_injection_cfg: Any
    supply_injection_mode: str
    supply_injection_s_min: Optional[float]
    supply_injection_s_max: Optional[float]
    supply_injection_q: float
    supply_velocity_cfg: Any
    supply_velocity_mode: str
    supply_velocity_e_inj: Optional[float]
    supply_velocity_i_inj: Optional[float]
    supply_velocity_vrel_factor: Optional[float]
    supply_velocity_blend_mode: str
    supply_velocity_weight_mode: str
    supply_injection_weights: Optional[np.ndarray]
    supply_transport_mode: str
    supply_transport_headroom_gate: str
    supply_deep_tmix_orbits: Optional[float]
    supply_deep_enabled: bool
    supply_effective_rate: Optional[float]
    supply_reservoir_cfg: Any
    supply_reservoir_enabled: bool
    supply_reservoir_mass_total: Optional[float]
    supply_reservoir_mode: Optional[str]
    supply_reservoir_taper_fraction: Optional[float]
    supply_feedback_cfg: Any
    supply_feedback_enabled: bool
    supply_feedback_tau_field: str
    supply_feedback_target: Optional[float]
    supply_feedback_gain: Optional[float]
    supply_feedback_response_yr: Optional[float]
    supply_temperature_cfg: Any
    supply_temperature_mode: Optional[str]
    supply_temperature_enabled: bool
    supply_temperature_table_path: Optional[Path]
    supply_temperature_value_kind: Optional[str]
    supply_table_path: Optional[Path]
    supply_state: Any
    mu_reference_tau: Optional[float]
    sigma_surf_mu_ref: Optional[float]
    pending_deprecation_warnings: List[str]


@dataclass
class RunZeroDTimeGridStage:
    t_end: float
    dt_nominal: float
    dt_initial_step: float
    n_steps: int
    time_grid_info: Dict[str, Any]
    dt: float
    max_steps: int
    checkpoint_cfg: Any
    resume_cfg: Any
    ...
    force_streaming_off: bool
    force_streaming_on: bool
    streaming_memory_limit_gb: float
    streaming_step_interval: int
    streaming_compression: str
    streaming_merge_at_end: bool
    streaming_cleanup_chunks: bool
    streaming_merge_outdir: Optional[Path]
    streaming_merge_completed: Optional[bool]
    archive_cfg: Any
    archive_enabled_cfg: bool
    archive_enabled: bool
    archive_forced_off: bool
    archive_forced_on: bool
    archive_dir: Optional[Path]
    archive_root_resolved: Optional[Path]
    archive_dest_dir: Optional[Path]
    archive_trigger: str
    archive_merge_target: str
    archive_verify: bool
    archive_verify_level: str
    archive_keep_local: str
    archive_mode: str
    archive_record_volume_info: bool
...
def _prepare_supply_transport_init(
    cfg: Config,
    *,
    psd_state: Dict[str, Any],
    optical_depth_enabled: bool,
    sigma_tau1_cap_init: float | None,
    kappa_surf_initial: float,
    phi_tau_fn: Callable[[float], float] | None,
    los_factor: float,
    t_orb: float,
    area: float,
    ...
    return RunZeroDSupplyStage(
        supply_spec=supply_spec,
        supply_enabled_cfg=supply_enabled_cfg,
        supply_mode_value=supply_mode_value,
        supply_headroom_policy=supply_headroom_policy,
        supply_headroom_enabled=supply_headroom_enabled,
        supply_epsilon_mix=supply_epsilon_mix,
        supply_const_rate=supply_const_rate,
        supply_mu_orbit_cfg=supply_mu_orbit_cfg,
        supply_orbit_fraction=supply_orbit_fraction,
        supply_injection_cfg=supply_injection_cfg,
        supply_injection_mode=supply_injection_mode,
        supply_injection_s_min=supply_injection_s_min,
        supply_injection_s_max=supply_injection_s_max,
        supply_injection_q=supply_injection_q,
        ...
        supply_injection_weights=supply_injection_weights,
        supply_transport_mode=supply_transport_mode,
        supply_transport_headroom_gate=supply_transport_headroom_gate,
        supply_deep_tmix_orbits=supply_deep_tmix_orbits,
        supply_deep_enabled=supply_deep_enabled,
        supply_effective_rate=supply_effective_rate,
        supply_reservoir_cfg=supply_reservoir_cfg,
        supply_reservoir_enabled=supply_reservoir_enabled,
        supply_reservoir_mass_total=supply_reservoir_mass_total,
        supply_reservoir_mode=supply_reservoir_mode,
        supply_reservoir_taper_fraction=supply_reservoir_taper_fraction,
        supply_feedback_cfg=supply_feedback_cfg,
        supply_feedback_enabled=supply_feedback_enabled,
        supply_feedback_tau_field=supply_feedback_tau_field,
        supply_feedback_target=supply_feedback_target,
        supply_feedback_gain=supply_feedback_gain,
        supply_feedback_response_yr=supply_feedback_response_yr,
        supply_temperature_cfg=supply_temperature_cfg,
        supply_temperature_mode=supply_temperature_mode,
        supply_temperature_enabled=supply_temperature_enabled,
        supply_temperature_table_path=supply_temperature_table_path,
        supply_temperature_value_kind=supply_temperature_value_kind,
        supply_table_path=supply_table_path,
        supply_state=supply_state,
        mu_reference_tau=mu_reference_tau,
        sigma_surf_mu_ref=sigma_surf_mu_ref,
        pending_deprecation_warnings=pending_deprecation_warnings,
    )


def _prepare_time_grid_and_runtime(
    cfg: Config,
    *,
    Omega: float,
    t_orb: float,
    temp_runtime: tempdriver.RuntimeDriver,
    ...
    return RunZeroDTimeGridStage(
        t_end=t_end,
        dt_nominal=dt_nominal,
        dt_initial_step=dt_initial_step,
        n_steps=n_steps,
        ...
        checkpoint_next_time=checkpoint_next_time,
        quiet_mode=quiet_mode,
        progress_enabled=progress_enabled,
        progress=progress,
        step_diag_cfg=step_diag_cfg,
        step_diag_enabled=step_diag_enabled,
        step_diag_format=step_diag_format,
        step_diag_path_cfg=step_diag_path_cfg,
        step_diag_path=step_diag_path,
        streaming_state=streaming_state,
        streaming_enabled_cfg=streaming_enabled_cfg,
        force_streaming_off=force_streaming_off,
        force_streaming_on=force_streaming_on,
        streaming_memory_limit_gb=streaming_memory_limit_gb,
        streaming_step_interval=streaming_step_interval,
        streaming_compression=streaming_compression,
        streaming_merge_at_end=streaming_merge_at_end,
        streaming_cleanup_chunks=streaming_cleanup_chunks,
        streaming_merge_outdir=streaming_merge_outdir,
        streaming_merge_completed=streaming_merge_completed,
        archive_cfg=archive_cfg,
        archive_enabled_cfg=archive_enabled_cfg,
        archive_enabled=archive_enabled,
        archive_forced_off=archive_forced_off,
        archive_forced_on=archive_forced_on,
        archive_dir=archive_dir,
        archive_root_resolved=archive_root_resolved,
        archive_dest_dir=archive_dest_dir,
        archive_trigger=archive_trigger,
        archive_merge_target=archive_merge_target,
        archive_verify=archive_verify,
        archive_verify_level=archive_verify_level,
        archive_keep_local=archive_keep_local,
        archive_mode=archive_mode,
        archive_record_volume_info=archive_record_volume_info,
        ...
        s_min_floor_dynamic=s_min_floor_dynamic,
        s_min_evolved_value=s_min_evolved_value,
        psd_state=psd_state,
        M_loss_cum=M_loss_cum,
        M_sink_cum=M_sink_cum,
        M_spill_cum=M_spill_cum,
        M_sublimation_cum=M_sublimation_cum,
...
def run_zero_d(
    ...
    *,
    ...
    supply_stage = _prepare_supply_transport_init(
        cfg,
        psd_state=psd_state,
        optical_depth_enabled=optical_depth_enabled,
    ...
    supply_spec = supply_stage.supply_spec
    supply_enabled_cfg = supply_stage.supply_enabled_cfg
    supply_mode_value = supply_stage.supply_mode_value
    supply_headroom_policy = supply_stage.supply_headroom_policy
    supply_headroom_enabled = supply_stage.supply_headroom_enabled
    supply_epsilon_mix = supply_stage.supply_epsilon_mix
    supply_const_rate = supply_stage.supply_const_rate
    supply_mu_orbit_cfg = supply_stage.supply_mu_orbit_cfg
    supply_orbit_fraction = supply_stage.supply_orbit_fraction
    supply_injection_cfg = supply_stage.supply_injection_cfg
    supply_injection_mode = supply_stage.supply_injection_mode
    supply_injection_s_min = supply_stage.supply_injection_s_min
    supply_injection_s_max = supply_stage.supply_injection_s_max
    supply_injection_q = supply_stage.supply_injection_q
    supply_velocity_cfg = supply_stage.supply_velocity_cfg
    supply_velocity_mode = supply_stage.supply_velocity_mode
    supply_velocity_e_inj = supply_stage.supply_velocity_e_inj
    supply_velocity_i_inj = supply_stage.supply_velocity_i_inj
    supply_velocity_vrel_factor = supply_stage.supply_velocity_vrel_factor
    supply_velocity_blend_mode = supply_stage.supply_velocity_blend_mode
    supply_velocity_weight_mode = supply_stage.supply_velocity_weight_mode
    supply_injection_weights = supply_stage.supply_injection_weights
    supply_transport_mode = supply_stage.supply_transport_mode
    supply_transport_headroom_gate = supply_stage.supply_transport_headroom_gate
    supply_deep_tmix_orbits = supply_stage.supply_deep_tmix_orbits
    supply_deep_enabled = supply_stage.supply_deep_enabled
    supply_effective_rate = supply_stage.supply_effective_rate
    supply_reservoir_cfg = supply_stage.supply_reservoir_cfg
    supply_reservoir_enabled = supply_stage.supply_reservoir_enabled
    supply_reservoir_mass_total = supply_stage.supply_reservoir_mass_total
    supply_reservoir_mode = supply_stage.supply_reservoir_mode
    supply_reservoir_taper_fraction = supply_stage.supply_reservoir_taper_fraction
    supply_feedback_cfg = supply_stage.supply_feedback_cfg
    supply_feedback_enabled = supply_stage.supply_feedback_enabled
    supply_feedback_tau_field = supply_stage.supply_feedback_tau_field
    supply_feedback_target = supply_stage.supply_feedback_target
    supply_feedback_gain = supply_stage.supply_feedback_gain
    supply_feedback_response_yr = supply_stage.supply_feedback_response_yr
    supply_temperature_cfg = supply_stage.supply_temperature_cfg
    supply_temperature_mode = supply_stage.supply_temperature_mode
    supply_temperature_enabled = supply_stage.supply_temperature_enabled
    supply_temperature_table_path = supply_stage.supply_temperature_table_path
    supply_temperature_value_kind = supply_stage.supply_temperature_value_kind
    supply_table_path = supply_stage.supply_table_path
    supply_state = supply_stage.supply_state
    mu_reference_tau = supply_stage.mu_reference_tau
    sigma_surf_mu_ref = supply_stage.sigma_surf_mu_ref
    pending_deprecation_warnings = supply_stage.pending_deprecation_warnings

    time_grid_stage = _prepare_time_grid_and_runtime(
        cfg,
        Omega=Omega,
        t_orb=t_orb,
        temp_runtime=temp_runtime,
    ...
    t_end = time_grid_stage.t_end
    dt_nominal = time_grid_stage.dt_nominal
    dt_initial_step = time_grid_stage.dt_initial_step
    n_steps = time_grid_stage.n_steps
    time_grid_info = time_grid_stage.time_grid_info
    dt = time_grid_stage.dt
    max_steps = time_grid_stage.max_steps
    checkpoint_cfg = time_grid_stage.checkpoint_cfg
    resume_cfg = time_grid_stage.resume_cfg
    checkpoint_enabled = time_grid_stage.checkpoint_enabled
    checkpoint_interval_s = time_grid_stage.checkpoint_interval_s
    checkpoint_format = time_grid_stage.checkpoint_format
    checkpoint_keep_last = time_grid_stage.checkpoint_keep_last
    checkpoint_dir = time_grid_stage.checkpoint_dir
    resume_enabled = time_grid_stage.resume_enabled
    resume_path = time_grid_stage.resume_path
    start_step = time_grid_stage.start_step
    time_offset = time_grid_stage.time_offset
    checkpoint_next_time = time_grid_stage.checkpoint_next_time
    quiet_mode = time_grid_stage.quiet_mode
    progress_enabled = time_grid_stage.progress_enabled
    progress = time_grid_stage.progress
    step_diag_cfg = time_grid_stage.step_diag_cfg
    step_diag_enabled = time_grid_stage.step_diag_enabled
    step_diag_format = time_grid_stage.step_diag_format
    step_diag_path_cfg = time_grid_stage.step_diag_path_cfg
    step_diag_path = time_grid_stage.step_diag_path
    streaming_state = time_grid_stage.streaming_state
    streaming_enabled_cfg = time_grid_stage.streaming_enabled_cfg
    force_streaming_off = time_grid_stage.force_streaming_off
    force_streaming_on = time_grid_stage.force_streaming_on
    streaming_memory_limit_gb = time_grid_stage.streaming_memory_limit_gb
    streaming_step_interval = time_grid_stage.streaming_step_interval
    streaming_compression = time_grid_stage.streaming_compression
    streaming_merge_at_end = time_grid_stage.streaming_merge_at_end
    streaming_cleanup_chunks = time_grid_stage.streaming_cleanup_chunks
    streaming_merge_outdir = time_grid_stage.streaming_merge_outdir
    streaming_merge_completed = time_grid_stage.streaming_merge_completed
    archive_cfg = time_grid_stage.archive_cfg
    archive_enabled_cfg = time_grid_stage.archive_enabled_cfg
    archive_enabled = time_grid_stage.archive_enabled
    archive_forced_off = time_grid_stage.archive_forced_off
    archive_forced_on = time_grid_stage.archive_forced_on
    archive_dir = time_grid_stage.archive_dir
    archive_root_resolved = time_grid_stage.archive_root_resolved
    archive_dest_dir = time_grid_stage.archive_dest_dir
    archive_trigger = time_grid_stage.archive_trigger
    archive_merge_target = time_grid_stage.archive_merge_target
    archive_verify = time_grid_stage.archive_verify
    archive_verify_level = time_grid_stage.archive_verify_level
    archive_keep_local = time_grid_stage.archive_keep_local
    archive_mode = time_grid_stage.archive_mode
    archive_record_volume_info = time_grid_stage.archive_record_volume_info
    ...
    diagnostic_columns = time_grid_stage.diagnostic_columns
    history = time_grid_stage.history
    last_step_index = time_grid_stage.last_step_index
    sigma_surf = time_grid_stage.sigma_surf
    sigma_deep = time_grid_stage.sigma_deep
    s_min_effective = time_grid_stage.s_min_effective
    s_min_floor_dynamic = time_grid_stage.s_min_floor_dynamic
    s_min_evolved_value = time_grid_stage.s_min_evolved_value
    psd_state = time_grid_stage.psd_state
    M_loss_cum = time_grid_stage.M_loss_cum
    M_sink_cum = time_grid_stage.M_sink_cum
    M_spill_cum = time_grid_stage.M_spill_cum
    M_sublimation_cum = time_grid_stage.M_sublimation_cum
    M_hydro_cum = time_grid_stage.M_hydro_cum
    supply_state = time_grid_stage.supply_state
    ...
    def _run_time_evolution_loop() -> None:
        ...
        nonlocal orbit_loss_sink, orbit_time_accum, orbits_completed, psd_state, qpr_for_blow_step, qpr_mean_step
        nonlocal kappa_surf, sigma_deep, sigma_surf, s_min_effective, s_min_floor_dynamic, s_min_evolved_value, smol_sink_workspace
        nonlocal steps_since_flush, supply_clip_time, supply_clip_streak, supply_rate_scaled_initial, supply_reservoir_depleted_time, T_use
        nonlocal t_mix_seconds_current, t_orb_step, tau_gate_block_time, tau_stop_los_value, time, total_time_elapsed
    ...
    _run_time_evolution_loop()

    def _finalize_zero_d_outputs() -> None:
        nonlocal orbits_completed
