...
#### 背景と仮定
巨大衝突直後の火星表面は数千ケルビンまで加熱され、ロッシュ限界内の粒子は恒星光に近い強さの赤外放射を受けると考えられます。このとき、サブミクロン〜ミクロンサイズの粒子では、放射圧と重力の比 β が 0.5 を超え、軌道に束縛されない軌道に遷移します。
...
### 先行研究との対応
- 円盤の初期温度 ~2000 K、蒸気分率≲数 %、メートル級ドロップレットが 100 µm 粒子に砕かれる、という描像は Hyodo et al. (2017 I) の SPH 計算と衝突後進化に基づいています。:contentReference[oaicite:0]{index=0}:contentReference[oaicite:1]{index=1}  
