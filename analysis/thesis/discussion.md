...
それでも，短期損失の積算が「初期条件 → 生存条件」の接続で律速になり得る以上，この部分を単独に定量化する意義は大きい．得られた損失率や残存質量は，1D 計算の半径分布や外側輸送・集積モデルとの結合により，衛星形成シナリオ全体の整合性検証へ組み込める．また，巨大衝突直後の火星放射で凝縮粒子が除去され得るという議論とも整合的に，円盤がどの程度「選別」され得るかを定量化する基礎情報になる（[@Hyodo2018_ApJ860_150]）．
