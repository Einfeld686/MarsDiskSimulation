...
config_keys:
  ...
  - numerics.dt_init
code_path:
  - [marsdisk/physics/radiation.py#qpr_lookup [L254–L319]]
...
code_path:
  ...
  - [marsdisk/run_zero_d.py#run_zero_d [L259–L4671]]
run_stage:
...
config_keys:
  ...
  - numerics.dt_init
code_path:
  - [marsdisk/physics/surface.py#step_surface_density_S1 [L107–L183]]
  - [marsdisk/run_zero_d.py#run_zero_d [L259–L4671]]
run_stage:
  - surface loop
inputs:
