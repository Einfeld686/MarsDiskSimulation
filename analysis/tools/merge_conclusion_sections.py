...
SECTIONS_DIR = REPO_ROOT / "analysis" / "thesis_sections" / "05_conclusion"
OUTPUT_PATH = REPO_ROOT / "analysis" / "thesis" / "conclusion.md"
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Merge conclusion section files into analysis/thesis/conclusion.md."
    )
    parser.add_argument(
        "--sections-dir",
        type=Path,
    ...
    parser.add_argument(
        ...
        type=Path,
        default=OUTPUT_PATH,
        help="Output path for the merged conclusion document.",
    )
    parser.add_argument(
        "--write",
        action="store_true",
    ...
    if args.write:
        ...
        print(f"merge_conclusion_sections: wrote {args.output}")
        return 0
