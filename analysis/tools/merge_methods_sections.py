...
SECTIONS_DIR = REPO_ROOT / "analysis" / "methods_sections"
OUTPUT_PATH = REPO_ROOT / "analysis" / "methods.md"
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Merge methods section files into analysis/methods.md."
    )
    parser.add_argument(
        "--sections-dir",
        type=Path,
