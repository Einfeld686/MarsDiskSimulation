...
SECTIONS_DIR = REPO_ROOT / "analysis" / "thesis_sections" / "00_abstract"
OUTPUT_PATH = REPO_ROOT / "analysis" / "thesis" / "abstract.md"
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Merge abstract section files into analysis/thesis/abstract.md."
    )
    parser.add_argument(
        "--sections-dir",
        type=Path,
    ...
    parser.add_argument(
        ...
        type=Path,
        default=OUTPUT_PATH,
        help="Output path for the merged abstract document.",
    )
    parser.add_argument(
        "--write",
        action="store_true",
    ...
    if args.write:
        ...
        print(f"merge_abstract_sections: wrote {args.output}")
        return 0
