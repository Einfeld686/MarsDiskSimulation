...
SECTIONS_DIR = REPO_ROOT / "analysis" / "thesis_sections" / "02_related_work"
OUTPUT_PATH = REPO_ROOT / "analysis" / "thesis" / "related_work.md"
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Merge related work section files into analysis/thesis/related_work.md."
    )
    parser.add_argument(
        "--sections-dir",
        type=Path,
    ...
    parser.add_argument(
        ...
        type=Path,
        default=OUTPUT_PATH,
        help="Output path for the merged related work document.",
    )
    parser.add_argument(
        "--write",
        action="store_true",
    ...
    if args.write:
        ...
        print(f"merge_related_work_sections: wrote {args.output}")
        return 0
