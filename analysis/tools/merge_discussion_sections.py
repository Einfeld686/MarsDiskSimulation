...
SECTIONS_DIR = REPO_ROOT / "analysis" / "thesis_sections" / "04_discussion"
OUTPUT_PATH = REPO_ROOT / "analysis" / "thesis" / "discussion.md"
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Merge discussion section files into analysis/thesis/discussion.md."
    )
    parser.add_argument(
        "--sections-dir",
        type=Path,
    ...
    parser.add_argument(
        ...
        type=Path,
        default=OUTPUT_PATH,
        help="Output path for the merged discussion document.",
    )
    parser.add_argument(
        "--write",
        action="store_true",
    ...
    if args.write:
        ...
        print(f"merge_discussion_sections: wrote {args.output}")
        return 0
